...
### 13.1. Анализ пропускной способности Yandex Cloud CDN: 100–150 Мбит/с — на пользователя или на всех?
...
- При активном веб-серфинге один пользователь генерирует в среднем от 10 000 до 50 000 HTTP-запросов в час.
- Пул в 100 млн запросов позволяет комфортно обслуживать постоянную базу из десятков активных пользователей в месяц без превышения порога бесплатных запросов.
