...
1. **150 ГБ входящего/исходящего CDN-трафика в месяц** на один ресурс (бесплатный пул).
2. **100 000 000 бесплатных HTTP-запросов в месяц** на каждый CDN-ресурс.
3. Сверх лимита тарифицируется трафик (~1.30–1.80 руб./ГБ в зависимости от объемов).
