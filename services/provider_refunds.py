...
async def recover_stale(session=None, lease_seconds=REFUND_LEASE_SECONDS) -> int:
    """Recover stale refund operations (delegates to isolated per-user transaction handler when session is None)."""
