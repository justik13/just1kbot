...
Приглашайте друзей и получайте <b>10% от каждого их пополнения баланса внутри бота</b> на реферальный бонусный баланс.
...
• Ваш приглашённый пользователь пополняет баланс внутри бота.
• Вы получаете <b>10%</b> от суммы пополнения на реферальный бонусный баланс.
• Бонусный баланс автоматически расходуется на покупку подписок.
• Начисление происходит после успешного зачисления пополнения.
