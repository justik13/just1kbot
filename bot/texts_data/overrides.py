...
# Device card header: clean and user-friendly
...
Используйте основной способ — кнопку «🔑 Показать ключ» для импорта в приложение <b>AmneziaVPN</b> или обратитесь в <b>💬 Поддержку</b>."""
