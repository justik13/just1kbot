...
🔐 Здесь вы можете подключить свои устройства к just1kbot в один клик.
...
<i>Используя бот, вы автоматически соглашаетесь с Условиями сервиса и Политикой конфиденциальности.</i>""",
...
1️⃣ <b>.vpn</b> — импортируйте в приложение <b>AmneziaVPN</b> (универсальный клиент).
2️⃣ <b>.conf</b> — импортируйте в приложение <b>AmneziaWG</b> (быстрый клиент).

<i>💡 Нажмите на прикреплённый файл выше, чтобы открыть его в соответствующем приложении.</i>""",
...
Перейдите в раздел «🔌 Подключения», создайте устройство и скачайте файл конфигурации для AmneziaVPN или AmneziaWG.

📌 <b>2. Что делать, если не работает подключение?</b>
Попробуйте удалить устройство и создать его заново. Если проблему не удалось решить — напишите оператору в поддержку.

📌 <b>3. Как продлить доступ?</b>
Перейдите в раздел «⏳ Моя подписка» или «🛒 Купить подписку» в главном меню.

📌 <b>4. На скольких устройствах можно использовать?</b>
Количество доступных устройств зависит от вашего действующего тарифного плана.
...
Сервис не сохраняет логи вашей активности. Все соединения защищены современными шифрованными протоколами.""",
