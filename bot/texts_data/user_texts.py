...
<i>Скопируйте ключ в карточке устройства или используйте «🔄 Другой способ подключения».</i>""",
...
Пожалуйста, скопируйте ключ подключения на карточке устройства для импорта в приложение <b>AmneziaVPN</b> или обратитесь в <b>💬 Поддержку</b>.""",
