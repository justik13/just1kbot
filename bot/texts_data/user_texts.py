...
Максимум 16 символов: латиница, цифры, пробелы, дефисы, подчёркивания.""",
...
<i>Ключ слишком длинный для текстового сообщения, поэтому отправлен файлом.</i>""",
    ...
    "DEVICE_CONFIG_VPN_CAPTION": """📁 <b>Основной клиент подключения</b>

📱 Устройство: <b>{device_name}</b>

<i>Для универсального приложения</i>""",

    "DEVICE_CONFIG_CONF_CAPTION": """📁 <b>Файл конфигурации</b>
...
1️⃣ Первый файл импортируйте в <b>основной клиент</b>.
2️⃣ Второй файл импортируйте в <b>легковесный клиент</b>.
...
Пример: <code>http://127.0.0.1:4001</code>""",
    ...
    "ERROR_INVALID_DEVICE_NAME": "⚠️ Имя устройства должно быть от 1 до 16 символов (латиница, цифры, пробелы, дефисы, подчёркивания):",
