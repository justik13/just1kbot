TEXTS = {
    ...
    # MAIN MENU / START
    # ============================================================
    "WELCOME_TEXT": """╭━━━━━━ 🚀 <b>JUST1K VPN</b> ━━━━━━╮

⚡ <b>Быстрый и безотказный VPN</b> для всех ваших устройств.

🛡 <b>Преимущества:</b>
• Современные протоколы защищённого доступа
• Безлимитный трафик на высокой скорости
• Подключение в 1 клик на iOS, Android, Windows и Mac

👇 <i>Воспользуйтесь меню ниже для настройки:</i>
╰━━━━━━━━━━━━━━━━━━━━━━╯""",

    "HUB_HEADER": """╭━━━━━━ ⚡ <b>JUST1K VPN</b> ━━━━━━╮

👤 <b>Пользователь:</b> <b>{name}</b>
💰 <b>Баланс:</b> <code>{balance} ₽</code>

⚡ <b>Скорость:</b> До 10 Гбит/с без ограничений

Выберите нужный раздел в меню:
╰━━━━━━━━━━━━━━━━━━━━━━╯""",

    "FALLBACK_MEDIA_TEXT": """🤖 <b>Я пока не умею обрабатывать медиафайлы.</b>

Пожалуйста, воспользуйтесь кнопками меню ниже или перейдите в поддержку.""",

    "FALLBACK_UNKNOWN_TEXT": """🤖 <b>Я не распознал эту команду.</b>

Пожалуйста, воспользуйтесь кнопками навигации ниже.""",
...
├ ⏱ {last_connected_text}
└ 📊 ∑ {traffic_total} (↓ {traffic_down} / ↑ {traffic_up})
""",
...
📍 <b>Локация:</b> {flag} {server_name}
📡 <b>Протокол:</b> {protocol}
📊 <b>Трафик:</b> ∑ {traffic_total}
⏱ <b>Активность:</b> {last_connected}

💡 <i>Нажмите «🔑 Показать ключ», чтобы скопировать ключ подключения.</i>
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯""",
...
<i>Файл конфигурации (.conf) для приложения AmneziaWG</i>""",
    ...
    "DEVICE_CONFIG_INSTRUCTION": """╭━━━━ 📥 <b>Настройка подключения</b> ━━━━╮

1️⃣ <b>AmneziaVPN (.vpn)</b>:
   Идеальный выбор для всех устройств. Скачайте файл выше и открывайте в приложении.

2️⃣ <b>AmneziaWG (.conf)</b>:
   Скоростной клиент. Откройте прикреплённый файл <code>.conf</code>.

💡 <i>Просто нажмите на прикреплённый файл выше — Telegram предложит импортировать его.</i>
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯""",

    "DOWNLOAD_CONF_FALLBACK": """⚠️ <b>Не удалось автоматически собрать .conf файл</b> для устройства <b>{device_name}</b>.

Пожалуйста, используйте кнопку «🔑 Показать ключ» для ручного импорта в приложение AmneziaWG или обратитесь в <b>💬 Поддержку</b>, мы поможем настроить подключение.""",
...
👋 Возникли вопросы по настройке или оплате? Наш специалист на связи!

👤 <b>Оператор:</b> {support_username}

⏱ <i>Отвечаем максимально быстро в течение 24h.</i>
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯""",

    "FAQ_TEXT": """❓ <b>Частые вопросы (FAQ)</b>

📌 <b>1. Как настроить подключение?</b>
Перейдите в раздел «🔌 Подключения», создайте устройство и скачайте файл конфигурации.

📌 <b>2. Что делать, если не работает подключение?</b>
Попробуйте пересоздать устройство или напишите нашему оператору в поддержку.

📌 <b>3. Как продлить доступ?</b>
Перейдите в раздел «⏳ Моя подписка» или «🚀 Купить доступ» в главном меню.

📌 <b>4. На скольких устройствах можно использовать?</b>
Количество доступных устройств зависит от вашего тарифного плана.

📌 <b>5. Как получить бонусы за друзей?</b>
В разделе «👤 Профиль» нажмите «👥 Рефералы» и отправьте вашу персональную ссылку друзьям.

📌 <b>6. Безопасны ли мои данные?</b>
Сервис не сохраняет логи вашей активности. Все соединения защищены шифрованием.""",
    ...
    # PAYMENT / SHOWCASE
    # ============================================================
    "PAYMENT_SHOWCASE_HEADER": """╭━━━━ 🛡 <b>Выбор подписки</b> ━━━━╮

Выберите подходящий тариф. Все серверы работают без ограничений по скорости и трафику.
""",

    "PAYMENT_HUB_HEADER": """╭━━━━ ⏳ <b>Ваша подписка</b> ━━━━╮

🟢 <b>Статус:</b> Активна
📅 <b>Действует до:</b> <b>{valid_until}</b> <i>(осталось {days_left})</i>

💎 <b>Тариф:</b> {tariff_name}
🔌 <b>Устройства:</b> {devices_count} из {device_limit} активны
...
⚠️ <b>Важно:</b>
🔼 <b>Расширение тарифа</b> (больше устройств) — применится мгновенно.
🔽 <b>Переход на меньший тариф</b> (меньше устройств) — <b>недоступен</b> во время активной подписки, чтобы случайно не отключить ваши устройства.
