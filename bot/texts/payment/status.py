...
NOTIF_OPEN_CONNECTIONS_BUTTON = '📱 Мои подключения'
NOTIF_OPEN_SUBSCRIPTION_BUTTON = '📋 Подписка'
NOTIF_BUY_NEW_SUBSCRIPTION_BUTTON = '📦 Купить подписку'
