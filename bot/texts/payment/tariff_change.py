...
Оставшаяся стоимость подписки будет зачтена при переходе.
...
Сменить тариф с перерасчётом можно только при активной подписке.
Для оформления новой подписки воспользуйтесь кнопкой ниже."""
