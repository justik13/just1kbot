...
NOTIFY_WI_3D = "⏳ <b>Белый Интернет: осталось 3 дня</b>\n\nПодписка действует до {date} UTC. Вы можете продлить её в любой момент."
NOTIFY_WI_1D = "⏳ <b>Белый Интернет: остался 1 день</b>\n\nПодписка истекает {countdown}. Рекомендуем продлить её заранее."
NOTIFY_WI_2H = "⏳ <b>Белый Интернет: осталось менее 2 часов</b>\n\nПодписка истекает {countdown}. Продлите её заранее, чтобы оставаться на связи."
