...
NOTIFY_INACTIVE_SUB_DEVICE = """⚠️ <b>Неактивное устройство</b>

Устройство <b>{device_label}</b> не выходило на связь более 7 дней.

Так как все слоты для ваших устройств заняты, вы можете отключить это неактивное устройство и освободить слот для нового подключения."""
...
NOTIFY_WI_3D = "⏳ <b>Белый Интернет: осталось 3 дня</b>\n\nПодписка действует до {date} (МСК). Вы можете продлить её в любой момент."
NOTIFY_WI_1D = "⏳ <b>Белый Интернет: остался 1 день</b>\n\nПодписка истекает через {countdown}. Рекомендуем продлить её заранее."
NOTIFY_WI_2H = "⏳ <b>Белый Интернет: осталось менее 2 часов</b>\n\nПодписка истекает через {countdown}. Продлите её заранее, чтобы оставаться на связи."
NOTIFY_WI_EXPIRED = "🔴 <b>Подписка «Белый Интернет» истекла</b>\n\nДоступ временно приостановлен. Чтобы возобновить подключение, продлите подписку."
BTN_EXTEND_WHITE_INTERNET = "🌐 Продлить Белый Интернет"
