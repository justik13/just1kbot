...
ALERT_SERVER_DISK_CRITICAL = """⚠️ <b>ВНИМАНИЕ: Диск ноды забит > 85%!</b>

Сервер: <b>{server_name}</b> (ID: {server_id})
Использование диска: <b>{disk_percent:.1f}%</b>
Рекомендуется очистить логи или расширить диск."""

ALERT_SERVER_PROBLEM = """⚠️ <b>Проблема с сервером</b>
...
ALERT_SERVER_RESTORED = """✅ <b>Сервер восстановлен</b>
