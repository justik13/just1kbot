...
CONNECTION_CONFIG_COMMON_NE_BYLO_AKTIVNOSTEY = "⏱ не было активностей"
...
CONNECTION_GUIDE_SAVE_CONF_FILE = """1. Сохраните прикреплённый файл <code>.conf</code> (для <b>AmneziaWG</b>, <b>DefaultVPN</b> или роутеров с поддержкой AmneziaWG — Keenetic AWG).
"""
...
BTN_OPEN_INCY_APP = "🚀 Открыть в приложении INCY"
...
У вас нет активной подписки. Оформите доступ для подключения."""
...
AWG_BROWSER_BTN_COPY_SUB = BTN_COPY_SUB_LINK
AWG_BROWSER_URL_LABEL = "Ссылка для ручного импорта:"
AWG_BROWSER_COPY_HINT = "Нажмите для копирования"
AWG_BROWSER_NOT_INSTALLED = "Если приложение ещё не установлено:"
AWG_BROWSER_STEP_1 = "Установите <b>INCY</b> из нужного магазина ниже."
AWG_BROWSER_STEP_2 = "Нажмите <b>«Открыть в приложении INCY»</b> выше (или скопируйте ссылку и добавьте через «+» в приложении)."
AWG_BROWSER_STEP_3 = "Включите соединение на главном экране INCY."
