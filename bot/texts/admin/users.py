...
ADMIN_USERS_MASS_BONUS_SELECT_SERVER = "Выберите сервер, пользователям которого будут начислены бонусы:"
ADMIN_USERS_MASS_BONUS_SERVER_AUDIENCE_LABEL = "Пользователям сервера {flag} {name}"
...
ADMIN_WI_TRIAL_EXTEND_FORBIDDEN = (
    "Продление пробного периода недоступно. Пользователь должен перейти на платную подписку"
)

ADMIN_WI_TRIAL_ACTION_FORBIDDEN = (
    "Изменение параметров пробного периода недоступно. Пользователь должен перейти на платную подписку"
)
