...
DEFAULT_WHITE_INTERNET_PATH_DE = os.getenv("WHITE_INTERNET_XHTTP_PATH_DE", "/stream/v1/de")
DEFAULT_WHITE_INTERNET_PATH_NL = os.getenv("WHITE_INTERNET_XHTTP_PATH_NL", "/stream/v1/nl")
