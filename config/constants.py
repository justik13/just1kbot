...
WHITE_INTERNET_BASE_TRAFFIC_BYTES = int(os.getenv("WHITE_INTERNET_BASE_TRAFFIC_BYTES", str(53_687_091_200)))  # 50 GiB
WHITE_INTERNET_MAX_QUOTA_BYTES = int(os.getenv("WHITE_INTERNET_MAX_QUOTA_BYTES", str(536_870_912_000)))   # 500 GiB
...
DEFAULT_WHITE_INTERNET_PATH_NL = DEFAULT_WHITE_INTERNET_PATH
