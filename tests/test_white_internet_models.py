...
class WhiteInternetModelsTests(unittest.TestCase):
    def test_alembic_migration_0022_revision_chain(self):
        ...
        rev_0020 = scripts.get_revision("0020_wi_reset_hard_delete")
        self.assertIsNotNone(rev_0020)
        self.assertEqual(rev_0020.down_revision, "0019_wi_server_set_null")
        ...
        rev_0023 = scripts.get_revision("0023_wi_active_hwids")
        self.assertIsNotNone(rev_0023)
        self.assertEqual(rev_0023.down_revision, "0022_servers_protocol_not_null")
        ...
        rev_0027 = scripts.get_revision("0027_awg_subscription_system")
        self.assertIsNotNone(rev_0027)
        self.assertEqual(rev_0027.down_revision, "0026_wi_trial_semantics")
        ...
        rev_0030 = scripts.get_revision("0030_wi_notify_90p")
        self.assertIsNotNone(rev_0030)
        self.assertEqual(rev_0030.down_revision, "0029_wi_notify_and_quote_opt")
